...
public interface FunctionApply {
     ...
     * @return
     */
    List<Integer> getPlanActIds(Function<List<Integer>, List<Integer>> function1,
                                Function<List<Integer>, List<Integer>> function2,
                                Function<List<Integer>, List<Integer>> function3,
                                List<Integer> ids);
