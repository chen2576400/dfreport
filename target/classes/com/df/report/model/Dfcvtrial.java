...
public class Dfcvtrial implements Serializable {
    ...
    private String groupReferenceReferenceClass;

    private Long groupReferenceReferenceId;
    ...
    private String proposeRefClass;

    private Long proposeRefId;

    private Date provideSampleTime;

    private Date requireCompleteTime;

    private String resultNotificationType;

    private String sapOrderInfo;
